...
function Card({
  ...
  return (
    ...
    >
      <div 
        className="relative w-full h-full flex-col flex justify-between transition-all duration-300 ease-in-out overflow-hidden"
...
export default function ToolCards({
  ...
  return (
    <div className={`w-full grid md:grid-cols-3 gap-10 mt-5 sm:mt-15 ${className}`}>
